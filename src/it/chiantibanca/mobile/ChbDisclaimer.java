...
public class ChbDisclaimer extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState){         
       ...
       boolean accepted = sharedPref.getBoolean("pref_disclaimer_choice", false);
       if( accepted ){
           // OK Start Activity
           ...
           // NO Display Dialogs
			...
			ChkDisclaimer.show(getFragmentManager(), "ChkDisclaimer");
       }
    }

	@Override
	public void onChkDisclaimerDialogPositiveClick(ChkDisclaimerDialogFragment dialog) {
			//Salva pref
		    SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
	...
	@Override
	public void onChkDisclaimerDialogNegativeClick(ChkDisclaimerDialogFragment dialog) {
		finish();
	}
}
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        */
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
 	 	return builder.setMessage(R.string.dialog_disclaimer_message)
 	 			.setCancelable(false)
     	        ...
     	        .setPositiveButton(R.string.dialog_accept, new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int id) {
	                         ...
	                         mListener.onChkDisclaimerDialogPositiveClick(ChkDisclaimerDialogFragment.this);
	                     }
     	        })
     	        .setNegativeButton(R.string.dialog_reject, new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int id) {
	                         ...
	                         mListener.onChkDisclaimerDialogNegativeClick(ChkDisclaimerDialogFragment.this);
	                     }
     	        })
 	 			.create(); 	 
	}
