...
public class DialogFragmentSaveCredentials extends DialogFragment {

    public DialogFragmentSaveCredentials() {
 	 	...
 	 	return builder.setMessage(R.string.dialog_rcredentials_message)
     	        ...
     	        .setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int id) {
	                         ...
	                         mListener.onSaveCredentialsDialogPositiveClick(DialogFragmentSaveCredentials.this);
	                     }
     	        })
     	        .setNegativeButton(R.string.dialog_no, new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int id) {
	                         ...
	                         mListener.onSaveCredentialsDialogNegativeClick(DialogFragmentSaveCredentials.this);
	                     }
     	        })
 	 			.create(); 	 
	}
